...
function order(){
  $.ajax({
    url:'/E-Commerce/api/customer/payment/finish.php',
    contentType: 'application/json',
    success:function(response){
        alert(response.message);
        console.log(response);
        var x = "http://localhost/E-Commerce/views/php/customer/home.php";
...
$(function(){
    ...
    $.ajax({
       url:'/E-Commerce/api/customer/cart/cart_read.php',
       contentType: 'application/json',
       success:function(response){
           console.log(response);
           
            var tbodyEle = $('#table');
            var tbodyEle3 = $('#table3');
